    ...
    <div className="min-h-screen bg-gradient-to-br from-green-400 to-blue-500 py-8">
      <div className="max-w-4xl mx-auto px-4">
        <div className="bg-white rounded-lg shadow-xl p-8 text-center mb-8">
          ...
          <p className="text-xl text-gray-600 mb-2">Vos {tickets.length} ticket(s) ont été générés avec succès</p>
        ...
        <div className="bg-white rounded-lg shadow-lg p-6 text-center">
          ...
          <p className="text-gray-600 mb-4">
            Un récapitulatif de votre achat avec vos numéros de tickets a été envoyé à <strong>{tickets[0]?.email}</strong>.
          </p>
          <button 
