import React, { useState, useEffect } from 'react'; // ✅ AJOUTER LES IMPORTS MANQUANTS
...
const Home = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-600 to-blue-500 text-white flex flex-col"> {/* ✅ AJOUTER flex flex-col */}
      
      {/* Contenu principal */}
      <div className="flex-grow"> {/* ✅ AJOUTER CETTE DIV */}
